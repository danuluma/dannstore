...
class UsersTest(Apiv2Test):
    ...
    def attendant_token(self):
        ...
        self.client().post('/dann/api/v2/signup',
                           headers={"Authorization": "Bearer " + access_token}, json=self.test_user)
        response = self.client().post('/dann/api/v2/login',
                                      headers={"Authorization": "Bearer " + access_token}, json=self.test_user)
        json_data = json.loads(response.data)
    ...
    def test_get_all_users_as_owner(self):
        ...
        self.client().post('/dann/api/v2/signup',
                           headers={"Authorization": "Bearer " + access_token}, json=self.test_user)
        response = self.client().get('/dann/api/v2/users',
                                     headers={"Authorization": "Bearer " + access_token})
        self.assertEqual(response.status_code, 200)
    ...
    def test_get_single_users_as_owner(self):
        ...
        self.client().post('/dann/api/v2/signup',
                           headers={"Authorization": "Bearer " + access_token}, json=self.test_user)
        response = self.client().get('/dann/api/v2/users/1',
                                     headers={"Authorization": "Bearer " + access_token})
        self.assertEqual(response.status_code, 200)
    ...
    def test_promote_user(self):
        ...
        self.client().post('/dann/api/v2/signup',
                           headers={"Authorization": "Bearer " + access_token}, json=self.test_user)
        response = self.client().put('/dann/api/v2/users/1',
        ...
        self.assertEqual(json_data.get('Message'),
                         "Success! User promoted to an admin")
        self.assertEqual(response.status_code, 201)
    ...
    def test_delete_a_user(self):
        ...
        self.client().post('/dann/api/v2/signup',
                           headers={"Authorization": "Bearer " + access_token}, json=self.test_user)
        response = self.client().delete('/dann/api/v2/users/1',
                                        headers={"Authorization": "Bearer " + access_token})
        json_data = json.loads(response.data)
        self.assertNotEqual(response.status_code, 200)
        self.assertTrue(json_data.get('Message'))
        self.assertEqual(json_data.get('Message'),
                         "Success! That user has been deleted")
        self.assertEqual(response.status_code, 201)
    ...
    def test_try_delete_a_fellow_user(self):
        ...
        self.assertTrue(json_data.get('Error'))
        self.assertEqual(json_data.get('Error'),
                         "Only the owner can delete attendants")
        self.assertEqual(response.status_code, 401)

    def test_user_logout(self):
        access_token = self.owner_token()
        response = self.client().delete('/dann/api/v2/logout',
                                        headers={"Authorization": "Bearer " + access_token})
        json_data = json.loads(response.data)
        self.assertTrue(json_data.get('Message'))
